---
title: MoniGo
description: Performance and Runtime Observability for Go Applications — real-time insights with an intuitive dashboard.
template: splash
hero:
  tagline: Performance and Runtime Observability for Go Applications — real-time insights into service-level and function-level metrics with an intuitive, built-in dashboard.
  image:
